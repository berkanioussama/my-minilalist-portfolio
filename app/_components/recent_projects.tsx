...
const RecentProjects = () => {
  return (
    <div className="py-20">
      ...
      <div className="flex flex-wrap gap-16 items-center justify-center p-4 mt-10">
    ...
    /*<div className="py-20">
      ...
      <div className="flex flex-wrap gap-16 items-center justify-center p-4 mt-10">
        {projects.map((project) => (
          <div key={project.id} className="flex items-center justify-center sm:w-[570px] w-[80vw] sm:h-[41vh] h-[32vh]">
            <PinContainer
              title={project.link}
              href={project.link}
            >
              <div className="relative flex items-center justify-center sm:w-[570px] w-[80vw] lg:h-[40rem] sm:h-[40vh] h-[30rem] mb-10 overflow-hidden">
                <div className="relative w-full h-full lg:rounded-3xl bg-[#13162d] overflow-hidden">
